...
\begin{enumerate}
	...
	\end{itemize}
	\item[b)] The method of Kitaev and Pachos \todo{include reference here.}
...
As described in sec.\hspace{0.2mm}\ref{sec4}, there are three theoretically equivalent method to create vortices
    ...
    (c) transforming into auxiliary fermion representation and fixing $u_{ij}$s (Kitaev and Pachos) \todo{reference?} \\
...
\end{figure}\todo{change captions in the table!}
...
It is worth to evaluate the energy of vortices by method c for large systems in the future.\todo{Should go into conclusions.}
