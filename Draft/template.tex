...
\author{
    M. Noormandipour\thanks{\texttt{mrn31@cam.ac.uk}}\hspace{1mm}$^{,a}$ , Y. H\thanks{\texttt{mrn31@cam.ac.uk}}\hspace{1mm}$^{,b}$ , B. Haghighat\thanks{\texttt{babak@math.tsinghua.edu.cn}}\hspace{1mm}$^{,b}$ \\
