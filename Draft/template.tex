...
%     \end{subfigure}%
    ...
    \caption{plots of first Brillouin zone and basis vectors}
    \label{fig:fig0}
\end{figure}
...
\noindent where \textbf{r} is the position vector of z-bonds or unit cells  (see Fig.\hspace{0.2mm}\ref{fig:fig6.6})\todo{@Reza: fix the figure}. It makes no difference in physics if we set \textbf{r} on every point along the z-bond, whether it is on even site or odd site or some where in the middle of them, that's a matter of translation! 
