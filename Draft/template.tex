...
\todo{we need to get rid of time column, as it does not show anything and depends on the cpu and ... computing resources we used.}
...
\end{figure}
\todo{@Youran: can you pls include the vertical lines in Fig11 as well? To separate different training phases?}
...
For the trained RBM state after performing QST for groundstate of $2 \times 2$ lattice, the expectation values of its four plaquette operators as well as the expected and measured energies are shown in Fig.\hspace{0.2mm}\ref{tab:pl0}. \todo{plots for energy/expectation-value of plaquettes vs iteration?} Moreover, flipping the $y$- and $z$-components of the spin at lattice site number $5$ (or equivalently, applying $\hat{S}_5^{x}$) will produce a pair of vortices at $B$ and $D$ plaquettes. Therefore, the expectation value of $\hat{W}_p$ operator in these plaquettes also flips sign (see Fig.\hspace{0.2mm}\ref{tab:pl5}). Similarly, applying $\hat{S}_7^{y}$, will kill the vortex in plaquette $D$ and produce one in plaquette $A$. The changes in the sign of expectation values for these plaquettes is shown in the Fig.\hspace{0.2mm}\ref{tab:pl7} below. Finally, by applying $\hat{S}_3^{z}$ we return back to the groundstate representation (see Fig.\hspace{0.2mm}\ref{tab:pl3}). These results, prove the effectiveness of the framework developed in Section\hspace{0.2mm}\ref{sec4} for realization of vortices in RBM states, in both QST and usual learning approaches.  

\begin{figure}[!htb]
	\centering
	\includegraphics[width=\textwidth]{./images/Plaquette0.png}
	\caption{\label{tab:pl0} Expectation values of plaquette operators for the RBM state after performing QST.} 
\end{figure}

\begin{figure}[!htb]
	\centering
	\includegraphics[width=\textwidth]{./images/Plaquette5.png}
	\caption{\label{tab:pl5} Expectation values of plaquette operators obtained after applying $\hat{S}_5^{x}$ on the system.} 
\end{figure}

\begin{figure}[!htb]
	\centering
	\includegraphics[width=\textwidth]{./images/Plaquette7.png}
	\caption{\label{tab:pl7} Expectation values of plaquette operators obtained after applying $\hat{S}_7^{y}$ on the system.} 
\end{figure}

\begin{figure}[!htb]
	\centering
	\includegraphics[width=\textwidth]{./images/Plaquette0.png}
	\caption{\label{tab:pl3} Expectation values of plaquette operators obtained after applying $\hat{S}_3^{z}$ on the system.} 
\end{figure}
