...
\keywords{Restricted Boltzmann Machine (RBM) \and Feed-Forward Neural Network (FFNN) \and Honeycomb Lattice Model \and Quantum State Tomography \and Topological Phases of Matter \and Anyons \and Quantum Computing}
...
As described in section \ref{sec:braiding}, there are three theoretically equivalent method to create vortices
